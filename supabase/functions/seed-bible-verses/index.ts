...
const verses = [
  {
    ref: "Giăng 3:16",
    content: "Vì Đức Chúa Trời yêu thương thế gian, đến nỗi đã ban Con một của Ngài, hầu cho hễ ai tin Con ấy không bị hư mất mà được sự sống đời đời.",
    tags: ["tình yêu", "cứu rỗi"],
  },
  { ref: "Thi Thiên 23:1", content: "Đức Giê-hô-va là Đấng chăn giữ tôi, tôi sẽ chẳng thiếu thốn gì.", tags: ["bình an", "tin cậy"] },
  {
    ref: "Châm Ngôn 3:5-6",
    content: "Hãy hết lòng tin cậy Đức Giê-hô-va, chớ nương cậy nơi sự thông sáng của con. Phàm trong các việc làm của con, khá nhận biết Ngài, thì Ngài sẽ chỉ dẫn các nẻo của con.",
    tags: ["đức tin", "hướng dẫn"],
  },
  ...
  {
    ref: "Giê-rê-mi 29:11",
    content: "Đức Giê-hô-va phán: Vì ta biết ý tưởng ta nghĩ đối cùng các ngươi, là ý tưởng bình an, không phải tai họa, để cho các ngươi được sự trông cậy trong lúc cuối cùng.",
    tags: ["hy vọng", "tương lai"],
  },
  ...
  {
    ref: "Ga-la-ti 5:22-23",
    content: "Nhưng trái của Thánh Linh, ấy là lòng yêu thương, sự vui mừng, bình an, nhịn nhục, nhân từ, hiền lành, trung tín, mềm mại, tiết độ.",
    tags: ["Thánh Linh", "phẩm hạnh"],
  },
  ...
  {
    ref: "Rô-ma 12:2",
    content: "Đừng làm theo đời nầy, nhưng hãy biến hóa bởi sự đổi mới của tâm thần mình, để thử cho biết ý muốn tốt lành, đẹp lòng và trọn vẹn của Đức Chúa Trời là thể nào.",
    tags: ["biến đổi", "đức tin"],
  },
  ...
  {
    ref: "Rô-ma 5:8",
    content: "Nhưng Đức Chúa Trời tỏ lòng yêu thương Ngài đối với chúng ta, khi chúng ta còn là người có tội, thì Đấng Christ vì chúng ta chịu chết.",
    tags: ["tình yêu", "cứu rỗi"],
  },
  ...
  {
    ref: "Thi Thiên 91:1-2",
    content:
      "Người nào ở nơi kín đáo của Đấng Chí Cao, sẽ được hằng ở dưới bóng của Đấng Toàn Năng. Tôi nói về Đức Giê-hô-va rằng: Ngài là nơi nương náu tôi, là đồn lũy tôi, là Đức Chúa Trời tôi, tôi tin cậy nơi Ngài.",
    tags: ["bảo vệ", "tin cậy"],
  },
  {
    ref: "Phi-líp 4:6-7",
    ...
    tags: ["bình an", "cầu nguyện"],
  },
  {
    ref: "Giô-suê 1:9",
    content: "Ta há chẳng có phán dặn ngươi sao? Hãy vững lòng bền chí, chớ run sợ, chớ kinh khủng; vì Giê-hô-va Đức Chúa Trời ngươi vẫn ở cùng ngươi trong mọi nơi ngươi đi.",
    tags: ["can đảm", "sức mạnh"],
  },
  ...
  { ref: "Thi Thiên 34:18", content: "Đức Giê-hô-va ở gần những người có lòng đau thương, và cứu kẻ nào có tâm hồn thống hối.", tags: ["an ủi", "chữa lành"] },
  {
    ref: "Rô-ma 8:38-39",
    content:
      "Vì tôi chắc rằng bất kỳ sự chết, sự sống, các thiên sứ, các kẻ cầm quyền, việc bây giờ, việc hầu đến, quyền phép, bề cao, hay bề sâu, hoặc một vật nào, chẳng có thể phân rẽ chúng ta khỏi sự yêu thương mà Đức Chúa Trời đã chứng cho chúng ta trong Đức Chúa Jêsus Christ.",
    tags: ["tình yêu", "bảo đảm"],
  },
  ...
  {
    ref: "Ê-sai 53:5",
    content: "Nhưng người đã vì tội lỗi chúng ta mà bị vết, vì sự gian ác chúng ta mà bị thương. Bởi sự sửa phạt người chịu chúng ta được bình an, bởi lằn roi người chúng ta được lành bệnh.",
    tags: ["cứu rỗi", "chữa lành"],
  },
  ...
  {
    ref: "Rô-ma 10:9",
    content: "Vậy nếu miệng ngươi xưng Đức Chúa Jêsus ra và lòng ngươi tin rằng Đức Chúa Trời đã khiến Ngài từ kẻ chết sống lại, thì ngươi sẽ được cứu.",
    tags: ["cứu rỗi", "đức tin"],
  },
  ...
  {
    ref: "Thi Thiên 103:1-3",
    content: "Hỡi linh hồn ta, khá ngợi khen Đức Giê-hô-va! Mọi điều gì ở trong ta hãy ca tụng danh thánh của Ngài! Hỡi linh hồn ta, hãy ngợi khen Đức Giê-hô-va, chớ quên các ơn lành của Ngài.",
    tags: ["ngợi khen", "tạ ơn"],
  },
  {
    ref: "Ê-phê-sô 6:10-11",
    content: "Vả lại, anh em phải làm mạnh dạn trong Chúa, nhờ sức toàn năng của Ngài. Hãy mang lấy mọi khí giới của Đức Chúa Trời, để được đứng vững mà địch cùng mưu kế của ma quỉ.",
    tags: ["chiến trận", "sức mạnh"],
  },
  ...
  {
    ref: "Rô-ma 6:23",
    content: "Vì tiền công của tội lỗi là sự chết; nhưng sự ban cho của Đức Chúa Trời là sự sống đời đời trong Đức Chúa Jêsus Christ, Chúa chúng ta.",
    tags: ["cứu rỗi", "ân điển"],
  },
  {
    ref: "Ma-thi-ơ 22:37-39",
    content:
      "Đức Chúa Jêsus đáp rằng: Ngươi hãy hết lòng, hết linh hồn, hết ý mà yêu mến Chúa, là Đức Chúa Trời ngươi. Ấy là điều răn thứ nhất và lớn hơn hết. Còn điều răn thứ hai giống như vậy: Ngươi hãy yêu kẻ lân cận như mình.",
    tags: ["tình yêu", "điều răn"],
  },
  {
    ref: "Giăng 16:33",
    content: "Ta đã bảo các ngươi những điều đó, hầu cho các ngươi có lòng bình an trong ta. Các ngươi sẽ có sự hoạn nạn trong thế gian, nhưng hãy cứ vững lòng, ta đã thắng thế gian rồi!",
    tags: ["bình an", "chiến thắng"],
  },
  ...
  {
    ref: "Giăng 11:25-26",
    content: "Đức Chúa Jêsus phán rằng: Ta là sự sống lại và sự sống; kẻ nào tin ta thì sẽ sống, mặc dầu đã chết rồi. Còn ai sống và tin ta thì không hề chết.",
    tags: ["sự sống", "phục sinh"],
  },
  ...
  {
    ref: "Rô-ma 15:13",
    content: "Vậy xin Đức Chúa Trời của sự trông cậy, làm cho anh em đầy dẫy mọi điều vui vẻ và mọi điều bình an trong đức tin, hầu cho anh em nhờ quyền phép Đức Thánh Linh được dư dật sự trông cậy.",
    tags: ["hy vọng", "vui mừng"],
  },
  ...
  {
    ref: "Hê-bơ-rơ 13:5",
    content: "Chớ tham tiền; hãy lấy điều mình có làm đủ rồi, vì chính Đức Chúa Trời có phán rằng: Ta sẽ chẳng lìa ngươi đâu, chẳng bỏ ngươi đâu.",
    tags: ["tin cậy", "bình an"],
  },
  ...
  {
    ref: "Gia-cơ 1:2-3",
    content: "Hỡi anh em, hãy coi sự thử thách trăm bề thoạt đến cho anh em như là điều vui mừng trọn vẹn, vì biết rằng sự thử thách đức tin anh em sanh ra sự nhịn nhục.",
    tags: ["thử thách", "đức tin"],
  },
  {
    ref: "1 Tê-sa-lô-ni-ca 5:16-18",
    content: "Hãy vui mừng mãi mãi, cầu nguyện không thôi, phàm làm việc gì cũng phải tạ ơn Chúa; vì ý muốn của Đức Chúa Trời trong Đức Chúa Jêsus Christ đối với anh em là vậy.",
    tags: ["vui mừng", "tạ ơn"],
  },
  {
    ref: "Thi Thiên 100:4-5",
    content: "Hãy cảm tạ mà vào các cửa Ngài, hãy ngợi khen mà vào hành lang Ngài. Khá cảm tạ Ngài, chúc tụng danh của Ngài. Vì Đức Giê-hô-va là thiện; sự nhân từ Ngài còn đến đời đời.",
    tags: ["ngợi khen", "tạ ơn"],
  },
  {
    ref: "Giăng 13:34-35",
    content: "Ta ban cho các ngươi một điều răn mới, nghĩa là các ngươi phải yêu nhau; như ta đã yêu các ngươi thể nào, thì các ngươi cũng hãy yêu nhau thể ấy.",
    tags: ["tình yêu", "điều răn"],
  },
  {
    ref: "Thi Thiên 42:11",
    content:
      "Hỡi linh hồn ta, cớ sao ngươi sờn ngã? Cớ sao ngươi bồn chồn trong ta? Hãy trông cậy nơi Đức Chúa Trời; ta sẽ còn ngợi khen Ngài nữa; Ngài là sự cứu rỗi của mặt ta, và là Đức Chúa Trời ta.",
    tags: ["hy vọng", "an ủi"],
  },
  {
    ref: "Ê-sai 43:2",
    content: "Khi ngươi vượt qua các dòng nước, ta sẽ ở cùng; khi ngươi lội qua sông, sẽ chẳng ngập. Khi ngươi bước qua lửa, sẽ chẳng bị cháy, ngọn lửa chẳng đốt ngươi.",
    tags: ["bảo vệ", "tin cậy"],
  },
  ...
  {
    ref: "Giăng 14:27",
    content: "Ta để sự bình an lại cho các ngươi; ta ban sự bình an ta cho các ngươi; ta cho các ngươi sự bình an chẳng phải như thế gian cho. Lòng các ngươi chớ bối rối và đừng sợ hãi.",
    tags: ["bình an"],
  },
  ...
  {
    ref: "Ê-sai 12:2",
    content: "Nầy, Đức Chúa Trời là sự cứu rỗi tôi; tôi sẽ tin cậy và không sợ hãi. Vì Đức Giê-hô-va, chính Đức Giê-hô-va, là sức mạnh tôi, là bài ca của tôi; Ngài đã nên sự cứu rỗi tôi.",
    tags: ["cứu rỗi", "can đảm"],
  },
  {
    ref: "1 Cô-rinh-tô 10:13",
    content: "Không có sự cám dỗ nào đến với anh em mà vượt quá sức loài người. Đức Chúa Trời là thành tín, Ngài chẳng hề cho anh em bị cám dỗ quá sức mình đâu.",
    tags: ["thử thách", "trung tín"],
  },
  ...
  { ref: "Thi Thiên 145:18", content: "Đức Giê-hô-va ở gần mọi người cầu khẩn Ngài, tức ở gần mọi người có lòng thành thực cầu khẩn Ngài.", tags: ["cầu nguyện", "gần gũi"] },
  {
    ref: "2 Sử Ký 7:14",
    content:
      "Nếu dân ta, là dân gọi bằng danh ta, hạ mình xuống, cầu nguyện, tìm kiếm mặt ta, và trở lại, bỏ con đường tà, thì ta sẽ ở trên trời nhậm lời, tha thứ tội chúng nó, và cứu xứ chúng nó khỏi tai vạ.",
    tags: ["ăn năn", "cầu nguyện"],
  },
  ...
  {
    ref: "Giăng 4:14",
    content: "Nhưng uống nước ta sẽ cho, thì chẳng hề khát nữa. Nước ta cho sẽ thành một mạch nước trong người đó, văng ra cho đến sự sống đời đời.",
    tags: ["sự sống", "Thánh Linh"],
  },
  ...
  {
    ref: "Thi Thiên 62:1-2",
    content: "Linh hồn tôi lặng lẽ chờ đợi Đức Chúa Trời; sự cứu rỗi tôi từ nơi Ngài mà đến. Chỉ một mình Ngài là hòn đá tôi, sự cứu rỗi tôi, và là nơi cao của tôi; tôi sẽ chẳng bị rúng động nhiều.",
    tags: ["tin cậy", "kiên nhẫn"],
  },
  ...
  {
    ref: "Ê-sai 43:18-19",
    content: "Đừng nhớ lại sự đã qua, và chớ nghĩ đến sự đời trước. Nầy, ta sắp làm một việc mới, việc ấy sẽ hiện ra ngay; các ngươi há chẳng biết sao?",
    tags: ["đổi mới", "hy vọng"],
  },
  {
    ref: "1 Giăng 4:4",
    content: "Hỡi các con cái bé mọn, phần các con, các con thuộc về Đức Chúa Trời, đã thắng được chúng nó rồi, vì Đấng ở trong các con lớn hơn kẻ ở trong thế gian.",
    tags: ["chiến thắng", "sức mạnh"],
  },
  {
    ref: "Ma-thi-ơ 11:29-30",
    content: "Ta có lòng nhu mì, khiêm nhường; nên hãy gánh lấy ách của ta, và học theo ta; thì linh hồn các ngươi sẽ được yên nghỉ. Vì ách ta dễ chịu và gánh ta nhẹ nhàng.",
    tags: ["bình an", "khiêm nhường"],
  },
  ...
  {
    ref: "Hê-bơ-rơ 4:16",
    content: "Vậy, chúng ta hãy vững lòng đến gần ngôi ơn phước, hầu cho được thương xót và tìm được ơn để giúp chúng ta trong thì giờ có cần dùng.",
    tags: ["ân điển", "cầu nguyện"],
  },
  ...
  {
    ref: "Giăng 8:12",
    content: "Đức Chúa Jêsus lại cất tiếng phán cùng chúng rằng: Ta là sự sáng của thế gian; người nào theo ta, chẳng đi trong nơi tối tăm, nhưng có ánh sáng của sự sống.",
    tags: ["ánh sáng", "Chúa Jêsus"],
  },
  {
    ref: "Châm Ngôn 3:9-10",
    content: "Hãy lấy tài vật và huê lợi đầu mùa của con mà tôn vinh Đức Giê-hô-va; vậy, các vựa lẫm con sẽ đầy dư dật, và các thùng con sẽ tràn rượu mới.",
    tags: ["dâng hiến", "phước hạnh"],
  },
  {
    ref: "1 Cô-rinh-tô 15:58",
    content: "Vậy, hỡi anh em yêu dấu của tôi, hãy vững vàng chớ rúng động, hãy làm công việc Chúa cách dư dật luôn, vì biết rằng công khó của anh em trong Chúa chẳng phải là vô ích đâu.",
    tags: ["phục vụ", "kiên nhẫn"],
  },
  {
    ref: "Thi Thiên 8:3-4",
    content: "Khi tôi nhìn xem các từng trời là công việc của ngón tay Chúa, mặt trăng và các ngôi sao mà Chúa đã đặt, loài người là gì mà Chúa nhớ đến? Con loài người là chi mà Chúa thăm viếng nó?",
    tags: ["sáng tạo", "ngợi khen"],
  },
  {
    ref: "Ma-thi-ơ 6:9-13",
    content:
      "Lạy Cha chúng tôi ở trên trời; danh Cha được thánh; nước Cha được đến; ý Cha được nên, ở đất như trời! Xin cho chúng tôi hôm nay đồ ăn đủ ngày. Xin tha tội lỗi cho chúng tôi, như chúng tôi cũng tha kẻ phạm tội nghịch cùng chúng tôi.",
    tags: ["cầu nguyện"],
  },
  {
    ref: "Rô-ma 3:23-24",
  ...
  {
    ref: "Ê-sai 58:11",
    content: "Đức Giê-hô-va sẽ cứ dắt dẫn ngươi; làm cho ngươi no lòng giữa nơi khô hạn lớn, và làm cho xương cốt ngươi mạnh. Ngươi sẽ như vườn đượm nước tưới, như suối nước không hề khô.",
    tags: ["hướng dẫn", "phước hạnh"],
  },
  ...
  {
    ref: "Ê-phê-sô 2:10",
    content: "Vì chúng ta là việc Ngài làm ra, đã được dựng nên trong Đức Chúa Jêsus Christ để làm việc lành mà Đức Chúa Trời đã sắm sẵn trước cho chúng ta làm theo.",
    tags: ["mục đích", "kêu gọi"],
  },
  {
    ref: "Ma-thi-ơ 17:20",
    content: "Nếu các ngươi có đức tin bằng một hạt cải, sẽ khiến núi nầy rằng: Hãy dời đi chỗ kia, thì nó liền dời đi, và không có sự gì mà các ngươi chẳng làm được.",
    tags: ["đức tin", "quyền năng"],
  },
  {
    ref: "Thi Thiên 84:11",
    content: "Vì Giê-hô-va Đức Chúa Trời là mặt trời và là cái thuẫn; Đức Giê-hô-va sẽ ban ân điển và vinh hiển; Ngài sẽ chẳng từ chối điều tốt lành gì cho ai ăn ở ngay thẳng.",
    tags: ["phước hạnh", "ân điển"],
  },
  ...
  {
    ref: "Rô-ma 12:1",
    content: "Vậy, hỡi anh em, tôi lấy sự thương xót của Đức Chúa Trời khuyên anh em dâng thân thể mình làm của lễ sống và thánh, đẹp lòng Đức Chúa Trời, ấy là sự thờ phượng phải lẽ của anh em.",
    tags: ["thờ phượng", "dâng hiến"],
  },
  ...
  {
    ref: "Ma-thi-ơ 7:24-25",
    content:
      "Vậy, kẻ nào nghe và làm theo lời ta phán đây, thì giống như một người khôn ngoan cất nhà mình trên hòn đá. Có mưa sa, nước chảy, gió lay, xô động nhà ấy; song không sập, vì đã cất trên đá.",
    tags: ["khôn ngoan", "vững vàng"],
  },
  ...
  {
    ref: "1 Cô-rinh-tô 16:13-14",
    content: "Hãy tỉnh thức, hãy vững vàng trong đức tin, hãy dốc chí trượng phu, hãy mạnh mẽ. Mọi điều anh em làm, hãy lấy lòng yêu thương mà làm.",
    tags: ["sức mạnh", "tình yêu"],
  },
  { ref: "Ma-thi-ơ 28:6", content: "Ngài không ở đây đâu; Ngài sống lại rồi, như lời Ngài đã phán.", tags: ["phục sinh", "vui mừng"] },
  {
    ref: "Thi Thiên 40:1-2",
    content:
      "Tôi đã nhịn nhục trông đợi Đức Giê-hô-va; Ngài nghiêng qua nghe tiếng kêu cầu của tôi. Ngài cũng đem tôi lên khỏi hầm gớm ghê, khỏi vũng bùn lầy, đặt chân tôi trên hòn đá, và làm cho bước tôi vững bền.",
    tags: ["kiên nhẫn", "giải cứu"],
  },
  ...
  {
    ref: "Giê-rê-mi 17:7-8",
    content: "Đáng chúc phước thay là kẻ nhờ cậy Đức Giê-hô-va, và lấy Đức Giê-hô-va làm sự trông cậy mình. Nó cũng như một cái cây trồng nơi bờ suối, đâm rễ theo dòng nước.",
    tags: ["tin cậy", "phước hạnh"],
  },
  ...
  {
    ref: "Giăng 3:3",
    content: "Đức Chúa Jêsus cất tiếng đáp rằng: Quả thật, quả thật, ta nói cùng ngươi, nếu một người chẳng sanh lại, thì không thể thấy được nước Đức Chúa Trời.",
    tags: ["tái sinh", "cứu rỗi"],
  },
  ...
  {
    ref: "Hê-bơ-rơ 10:25",
    content: "Chớ bỏ sự nhóm lại như mấy kẻ quen làm, nhưng phải khuyên bảo nhau, và hễ anh em thấy ngày ấy hầu gần chừng nào, thì càng phải làm như vậy chừng nấy.",
    tags: ["hội thánh", "hiệp một"],
  },
  ...
  {
    ref: "1 Phi-e-rơ 3:15",
    content: "Nhưng hãy tôn Đấng Christ, là Chúa, làm thánh trong lòng mình. Hãy thường thường sẵn sàng để trả lời mọi kẻ hỏi lẽ về sự trông cậy trong anh em.",
    tags: ["làm chứng", "đức tin"],
  },
  { ref: "Ma-thi-ơ 5:6", content: "Phước cho những kẻ đói khát sự công bình, vì sẽ được no đủ!", tags: ["phước hạnh", "công bình"] },
  {
    ref: "Giăng 5:24",
    content: "Quả thật, quả thật, ta nói cùng các ngươi, ai nghe lời ta mà tin Đấng đã sai ta, thì được sự sống đời đời, và không đến sự phán xét, song đã vượt khỏi sự chết mà đến sự sống rồi.",
    tags: ["sự sống", "cứu rỗi"],
  },
  ...
  {
    ref: "Châm Ngôn 3:3-4",
    content: "Chớ để sự nhân từ và sự chân thật lìa bỏ con; hãy đeo nó nơi cổ, viết nó trên bảng lòng con; vậy, con sẽ được ơn và có sự khôn sáng trước mặt Đức Chúa Trời và loài người.",
    tags: ["nhân từ", "khôn ngoan"],
  },
  {
    ref: "Ê-sai 54:10",
    content:
      "Dầu núi dời, dầu đồi chuyển, nhưng lòng nhân từ ta đối với ngươi sẽ không dời khỏi ngươi, lời giao ước bình an của ta sẽ chẳng chuyển, Đức Giê-hô-va, là Đấng thương xót ngươi, phán vậy.",
    tags: ["tình yêu", "giao ước"],
  },
  ...
  {
    ref: "Rô-ma 14:8",
    content: "Vì nếu chúng ta sống, là sống cho Chúa, và nếu chúng ta chết, là chết cho Chúa. Vậy nên chúng ta hoặc sống hoặc chết, đều thuộc về Chúa cả.",
    tags: ["sống cho Chúa", "dâng hiến"],
  },
  ...
  {
    ref: "Hê-bơ-rơ 11:6",
    content: "Vả, không có đức tin, thì chẳng hề có thể nào ở cho vừa lòng Đức Chúa Trời; vì kẻ đến gần Đức Chúa Trời phải tin rằng có Đức Chúa Trời, và Ngài là Đấng hay thưởng cho kẻ tìm kiếm Ngài.",
    tags: ["đức tin"],
  },
  {
    ref: "Ê-phê-sô 6:12",
    content: "Vì chúng ta đánh trận, chẳng phải cùng thịt và huyết, bèn là cùng chủ quyền, cùng thế lực, cùng vua chúa của thế gian mờ tối nầy, cùng các thần dữ ở các miền trên trời vậy.",
    tags: ["chiến trận", "tâm linh"],
  },
  ...
  {
    ref: "Thi Thiên 56:3-4",
    content: "Trong ngày sợ hãi, tôi sẽ nhờ cậy nơi Chúa. Tôi nhờ Đức Chúa Trời, và ngợi khen lời của Ngài; tôi để lòng tin cậy nơi Đức Chúa Trời, ắt sẽ chẳng sợ gì; loài xác thịt sẽ làm chi tôi?",
    tags: ["can đảm", "tin cậy"],
  },
  ...
  {
    ref: "1 Cô-rinh-tô 2:9",
    content: "Song le, như có chép rằng: Ấy là sự mắt chưa thấy, tai chưa nghe, và lòng người chưa nghĩ đến, nhưng Đức Chúa Trời đã sắm sẵn điều ấy cho những người yêu mến Ngài.",
    tags: ["hy vọng", "thiên đàng"],
  },
  ...
  {
    ref: "2 Cô-rinh-tô 4:16-17",
    content:
      "Vậy nên chúng tôi chẳng ngã lòng, dầu người bề ngoài hư nát, nhưng người bề trong cứ đổi mới càng ngày càng hơn. Vì sự hoạn nạn nhẹ và tạm của chúng tôi sanh cho chúng tôi sự vinh hiển cao trọng đời đời.",
    tags: ["hy vọng", "kiên nhẫn"],
  },
  {
    ref: "Thi Thiên 1:1-2",
    content:
    ...
    tags: ["phước hạnh", "lời Chúa"],
  },
  {
    ref: "Giăng 20:31",
    content: "Nhưng các việc nầy đã chép, để cho các ngươi tin rằng Đức Chúa Jêsus là Đấng Christ, Con Đức Chúa Trời, và để khi các ngươi tin, thì nhờ danh Ngài mà được sự sống.",
    tags: ["đức tin", "sự sống"],
  },
  {
    ref: "Ê-sai 1:18",
    content: "Đức Giê-hô-va phán: Bây giờ hãy đến, cho chúng ta biện luận cùng nhau. Dầu tội các ngươi như hồng điều, sẽ trở nên trắng như tuyết; dầu đỏ như son, sẽ trở nên trắng như lông chiên.",
  ...
  {
    ref: "Thi Thiên 95:1-2",
    content: "Hãy đến hát xướng cho Đức Giê-hô-va, cất tiếng mừng rỡ cho hòn đá về sự cứu rỗi chúng tôi! Chúng ta hãy lấy sự cảm tạ mà đến trước mặt Ngài, hãy lấy bài thơ ca mà reo mừng cho Ngài.",
    tags: ["ngợi khen", "thờ phượng"],
  },
  {
    ref: "Ê-phê-sô 3:16-17",
    content: "Tôi cầu xin Ngài tùy sự giàu có vinh hiển Ngài khiến anh em được nên mạnh mẽ bởi Thánh Linh Ngài trong người bề trong, và nhờ đức tin, Đấng Christ ngự trong lòng anh em.",
    tags: ["Thánh Linh", "sức mạnh"],
  },
  { ref: "Châm Ngôn 14:26", content: "Trong sự kính sợ Đức Giê-hô-va có nơi nương cậy vững chắc; và con cái Ngài sẽ được nơi ẩn núp.", tags: ["kính sợ Chúa", "bảo vệ"] },
  {
    ref: "Giăng 14:2-3",
    content:
      "Trong nhà Cha ta có nhiều chỗ ở; bằng chẳng vậy, ta đã nói cho các ngươi rồi. Ta đi sắm sẵn cho các ngươi một chỗ. Khi ta đã đi, và đã sắm sẵn cho các ngươi một chỗ rồi, ta sẽ trở lại đem các ngươi đi với ta.",
    tags: ["thiên đàng", "hy vọng"],
  },
  {
    ref: "Rô-ma 5:3-4",
    content: "Nào những thế thôi, nhưng chúng ta cũng khoe mình trong hoạn nạn nữa, vì biết rằng hoạn nạn sanh sự nhịn nhục, sự nhịn nhục sanh sự rèn tập, sự rèn tập sanh sự trông cậy.",
    tags: ["thử thách", "hy vọng"],
  },
  { ref: "Thi Thiên 107:1", content: "Hãy ngợi khen Đức Giê-hô-va, vì Ngài là thiện; sự nhân từ Ngài còn đến đời đời.", tags: ["ngợi khen", "nhân từ"] },
  {
    ...
    tags: ["công bình", "khiêm nhường"],
  },
  {
    ref: "Giăng 15:16",
    content: "Ấy chẳng phải các ngươi đã chọn ta, bèn là ta đã chọn và lập các ngươi, để các ngươi đi và kết quả, hầu cho trái các ngươi thường đậu luôn.",
    tags: ["kêu gọi", "kết quả"],
  },
  {
    ref: "Ma-thi-ơ 11:28-30",
    content: "Hỡi những kẻ mệt mỏi và gánh nặng, hãy đến cùng ta, ta sẽ cho các ngươi được yên nghỉ. Ta có lòng nhu mì, khiêm nhường; nên hãy gánh lấy ách của ta, và học theo ta.",
    tags: ["bình an", "nghỉ ngơi"],
  },
  {
    ref: "Ê-sai 46:4",
    content: "Cho đến chừng các ngươi già cả, đầu bạc, ta cũng sẽ bồng ẵm các ngươi. Ta đã tạo nên, ta sẽ gánh vác; ta sẽ bồng ẵm và giải cứu các ngươi.",
    tags: ["tin cậy", "chăm sóc"],
  },
  {
    ref: "Thi Thiên 143:8",
    content: "Xin cho tôi nghe sự nhân từ Chúa vào buổi sáng, vì tôi để lòng tin cậy nơi Chúa. Xin chỉ cho tôi biết con đường phải đi, vì linh hồn tôi ngưỡng vọng Chúa.",
    tags: ["hướng dẫn", "buổi sáng"],
  },
  { ref: "1 Giăng 4:18", content: "Quyết chẳng có điều sợ hãi trong sự yêu thương, nhưng sự yêu thương trọn vẹn thì cất bỏ sự sợ hãi.", tags: ["tình yêu", "can đảm"] },
  {
    ...
    tags: ["nhịn nhục", "cứu rỗi"],
  },
  {
    ref: "Thi Thiên 63:1",
    content: "Đức Chúa Trời ơi, Chúa là Đức Chúa Trời tôi, vừa sáng tôi tìm cầu Chúa; trong một đất khô khan, cực nhọc, chẳng có nước, linh hồn tôi khát khao Chúa.",
    tags: ["khao khát", "tìm kiếm"],
  },
  { ref: "Châm Ngôn 16:24", content: "Lời nói êm dịu giống như tàng ong, ngọt cho linh hồn và khỏe mạnh cho xương cốt.", tags: ["lời nói", "khôn ngoan"] },
  {
    ...
    tags: ["Thánh Linh", "cầu nguyện"],
  },
  {
    ref: "Khải Huyền 3:20",
    content: "Nầy, ta đứng ngoài cửa mà gõ; nếu ai nghe tiếng ta mà mở cửa cho, thì ta sẽ vào cùng người ấy, ăn bữa tối với người, và người với ta.",
    tags: ["mời gọi", "thông công"],
  },
  ...
  {
    ref: "Ê-phê-sô 4:2-3",
    content: "Phải khiêm nhường đến điều, mềm mại đến điều, phải nhịn nhục, lấy lòng thương yêu mà chìu nhau, dùng dây hòa bình mà giữ gìn sự hiệp một của Thánh Linh.",
    tags: ["hiệp một", "khiêm nhường"],
  },
  {
    ref: "Sáng Thế Ký 1:27",
    content: "Đức Chúa Trời dựng nên loài người như hình Ngài; Ngài dựng nên loài người giống như hình Đức Chúa Trời; Ngài dựng nên người nam cùng người nữ.",
    tags: ["sáng tạo", "danh phận"],
  },
  ...
  {
    ref: "Rô-ma 11:33",
    content: "Ôi! sâu nhiệm thay là sự giàu có, khôn ngoan và thông biết của Đức Chúa Trời! Sự phán xét của Ngài nào có thể dò, đường nẻo của Ngài nào có thể tìm được!",
    tags: ["khôn ngoan", "ngợi khen"],
  },
  {
    ref: "Thi Thiên 127:1",
    content: "Nếu Đức Giê-hô-va không cất nhà, thì những thợ xây cất làm uổng công. Nhược bằng Đức Giê-hô-va không coi giữ thành, thì người canh thức canh luống công.",
    tags: ["tin cậy", "gia đình"],
  },
  {
    ref: "Ma-thi-ơ 4:4",
    content: "Đức Chúa Jêsus đáp: Có lời chép rằng: Người ta sống chẳng phải chỉ nhờ bánh mà thôi, song nhờ mọi lời nói ra từ miệng Đức Chúa Trời.",
    tags: ["lời Chúa", "đức tin"],
  },
  ...
  {
    ref: "Ê-sai 40:28",
    content: "Ngươi không biết sao, không nghe sao? Đức Chúa Trời hằng sống, Đức Giê-hô-va, là Đấng đã dựng nên các đầu cùng đất, chẳng mỏi chẳng mệt; sự khôn ngoan Ngài không thể dò.",
    tags: ["quyền năng", "vĩnh cửu"],
  },
  {
    ref: "1 Phi-e-rơ 1:3",
    content:
      "Chúc tụng Đức Chúa Trời, là Cha Đức Chúa Jêsus Christ chúng ta, Ngài lấy lòng thương xót cả thể khiến chúng ta lại sanh, đặng chúng ta nhờ sự Đức Chúa Jêsus Christ sống lại từ trong kẻ chết mà có sự trông cậy sống.",
    tags: ["hy vọng", "tái sinh"],
  },
  ...
  {
    ref: "Thi Thiên 18:2",
    content: "Đức Giê-hô-va là hòn đá tôi, đồn lũy tôi, Đấng giải cứu tôi; Đức Chúa Trời là hòn đá tôi, nơi tôi nương náu mình; Ngài là cái thuẫn tôi, sừng cứu rỗi tôi, và là nơi ẩn trú cao của tôi.",
    tags: ["bảo vệ", "sức mạnh"],
  },
  ...
  {
    ref: "Khải Huyền 21:4",
    content: "Ngài sẽ lau ráo hết nước mắt khỏi mắt chúng, sẽ không có sự chết, cũng không có than khóc, kêu ca, hay là đau đớn nữa; vì những sự thứ nhất đã qua rồi.",
    tags: ["thiên đàng", "hy vọng"],
  },
  ...
  {
    ref: "Giăng 3:36",
    content: "Ai tin Con, thì được sự sống đời đời; ai không chịu tin Con, thì chẳng thấy sự sống đâu, nhưng cơn thạnh nộ của Đức Chúa Trời vẫn ở trên người đó.",
    tags: ["cứu rỗi", "đức tin"],
  },
  {
    ref: "Ê-sai 40:11",
    content: "Ngài sẽ chăn bầy mình như người chăn chiên; thâu các chiên con vào cánh tay mình và ẵm vào lòng; từ từ dắt các chiên cái đương cho bú.",
    tags: ["chăm sóc", "nhân từ"],
  },
  ...
  {
    ref: "Thi Thiên 115:13-14",
    content: "Ngài sẽ ban phước cho những kẻ kính sợ Đức Giê-hô-va, ban phước cho kẻ nhỏ và kẻ lớn. Nguyện Đức Giê-hô-va gia thêm phước cho các ngươi, cho các ngươi và cho con cháu các ngươi.",
    tags: ["phước hạnh", "gia đình"],
  },
  ...
  {
    ref: "Giê-rê-mi 1:5",
    content: "Trước khi ta chưa dựng nên ngươi trong lòng mẹ, ta đã biết ngươi rồi; trước khi ngươi chưa ra khỏi lòng mẹ, ta đã biệt riêng ngươi, lập ngươi làm kẻ tiên tri cho các nước.",
    tags: ["kêu gọi", "mục đích"],
  },
  ...
  {
    ref: "Châm Ngôn 3:13-14",
    content: "Phước cho người nào tìm được sự khôn ngoan, và cho người nào được sự thông sáng! Vì thà được sự khôn ngoan hơn là được bạc, huê lợi nó sanh ra tốt hơn vàng ròng.",
    tags: ["khôn ngoan", "phước hạnh"],
  },
  {
    ref: "1 Tê-sa-lô-ni-ca 4:16-17",
    content: "Vì chính Chúa sẽ từ trời giáng xuống cùng tiếng kêu lớn, tiếng của thiên sứ lớn cùng tiếng kèn của Đức Chúa Trời, thì những kẻ chết trong Đấng Christ sẽ sống lại trước hết.",
    tags: ["tái lâm", "hy vọng"],
  },
  ...
  {
    ref: "Ma-thi-ơ 9:37-38",
    content: "Ngài bèn phán cùng môn đồ rằng: Mùa gặt thì thật trúng, song con gặt thì ít. Vậy, hãy cầu nguyện Chúa mùa gặt sai con gặt đến trong mùa mình.",
    tags: ["sứ mệnh", "cầu nguyện"],
  },
  {
    ref: "Hê-bơ-rơ 11:3",
    content: "Bởi đức tin, chúng ta biết rằng thế gian đã làm nên bởi lời của Đức Chúa Trời, đến nỗi những vật bày ra đó đều chẳng phải từ vật thấy được mà đến.",
    tags: ["đức tin", "sáng tạo"],
  },
  ...
  {
    ref: "Ê-phê-sô 6:13",
    content: "Vậy nên, hãy lấy mọi khí giới của Đức Chúa Trời, hầu cho trong ngày khốn nạn, anh em có thể cự địch và khi thắng hơn mọi sự rồi, anh em được đứng vững vàng.",
    tags: ["chiến trận", "vững vàng"],
  },
  ...
  {
    ref: "Ê-sai 53:3",
    content: "Người đã bị người ta khinh dể và chán bỏ, từng trải sự buồn bực, biết sự đau ốm, bị khinh như kẻ mà người ta che mặt chẳng thèm xem.",
    tags: ["Chúa Jêsus", "hy sinh"],
  },
  ...
  {
    ref: "Ma-thi-ơ 7:12",
    content: "Ấy vậy, hễ điều chi mà các ngươi muốn người ta làm cho mình, thì cũng hãy làm điều đó cho họ, vì ấy là luật pháp và lời tiên tri.",
    tags: ["tình yêu", "luật vàng"],
  },
  ...
  {
    ref: "Rô-ma 12:9-10",
    content: "Lòng yêu thương phải cho thành thật. Hãy gớm sự dữ mà mến sự lành. Hãy lấy lòng yêu thương mềm mại mà yêu nhau như anh em; hãy lấy sự kính nhường nhau.",
    tags: ["tình yêu", "phẩm hạnh"],
  },
  {
    ref: "1 Cô-rinh-tô 13:13",
    content: "Nên bây giờ còn có ba điều nầy: đức tin, sự trông cậy, tình yêu thương; nhưng điều trọng hơn trong ba điều đó là tình yêu thương.",
    tags: ["tình yêu", "đức tin"],
  },
  {
    ref: "Giăng 14:26",
    content: "Nhưng Đấng Yên ủi, tức là Đức Thánh Linh mà Cha sẽ nhân danh ta sai xuống, Đấng ấy sẽ dạy dỗ các ngươi mọi sự, nhắc lại cho các ngươi nhớ mọi điều ta đã phán cùng các ngươi.",
    tags: ["Thánh Linh", "dạy dỗ"],
  },
  {
    ref: "Thi Thiên 37:23-24",
    content: "Đức Giê-hô-va định liệu các bước của người, và Ngài thích đường lối người. Dầu người té, cũng không nằm sải dài; vì Đức Giê-hô-va lấy tay nâng đỡ người.",
    tags: ["hướng dẫn", "nâng đỡ"],
  },
  { ref: "Châm Ngôn 18:21", content: "Sống chết ở nơi quyền của lưỡi; kẻ ái mộ nó sẽ ăn bông trái của nó.", tags: ["lời nói", "khôn ngoan"] },
  {
    ref: "2 Cô-rinh-tô 9:7",
    content: "Mỗi người nên tùy theo lòng mình đã định mà quyên ra, không phải phàn nàn hay vì ép uổng; vì Đức Chúa Trời yêu kẻ dâng của cách vui lòng.",
    tags: ["dâng hiến", "vui mừng"],
  },
];
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const { data: existingCat } = await supabase.from("blog_categories").select("id").eq("slug", "loi-chua").maybeSingle();

    let categoryId: string;
    if (existingCat) {
      categoryId = existingCat.id;
    } else {
      const { data: newCat, error: catErr } = await supabase.from("blog_categories").insert({ name: "Lời Chúa", slug: "loi-chua", icon: "✝️", sort_order: 10 }).select("id").single();
